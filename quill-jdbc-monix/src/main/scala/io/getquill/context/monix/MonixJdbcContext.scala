...
object MonixJdbcContext {
  /* TODO: I moved this here because it is actually specific to the MonixJdbcContext. For example
      it wasn't used at all in the CassandraMonixContext and the MonixNdbcContext requires different
      methods. */
  object Runner {
